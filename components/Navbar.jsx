    ...
    <div className="navbar w-auto mb-2 shadow-lg rounded-box bg-neutral text-neutral-content mx-auto">
      ...
      <div className="hidden px-2 mx-2 navbar-center md:flex ">
        <div className="flex items-stretch">
          ...
          <Link href="/upload" className="btn btn-ghost btn-sm rounded-btn">
            Upload
          </Link>
        </div>
      </div>
      <div className="navbar-end">
        <div className="dropdown dropdown-end">
          <div
            tabIndex={0}
            className="btn btn-ghost flex-nowrap normal-case gap-3"
          >
            <svg
              width="20"
              height="20"
            ...
            <svg
              width="12px"
              height="12px"
              className="ml-1 hidden h-3 w-3 fill-current opacity-60 sm:inline"
              xmlns="http://www.w3.org/2000/svg"
